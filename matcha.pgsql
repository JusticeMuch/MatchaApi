...
CREATE SCHEMA IF NOT EXISTS public AUTHORIZATION nhendric;
...
ALTER TABLE public.report_seq OWNER TO nhendric;

ALTER TABLE public.block_seq OWNER TO nhendric;

ALTER TABLE public.like_seq OWNER TO nhendric;
...
--
-- Name: Report; Type: TABLE; Schema: public; Owner: nhendric
--
...
ALTER TABLE public."Report" OWNER TO nhendric;
...
ALTER TABLE public."Like" OWNER TO nhendric;
...
ALTER TABLE public."Block" OWNER TO nhendric;

--
-- Name: match_seq; Type: SEQUENCE; Schema: public; Owner: nhendric
--
...
ALTER TABLE public.match_seq OWNER TO nhendric;

--
-- Name: Match; Type: TABLE; Schema: public; Owner: nhendric
--
...
ALTER TABLE public."Match" OWNER TO nhendric;

--
-- Name: message_seq; Type: SEQUENCE; Schema: public; Owner: nhendric
--
...
ALTER TABLE public.message_seq OWNER TO nhendric;

--
-- Name: Message; Type: TABLE; Schema: public; Owner: nhendric
--
...
ALTER TABLE public."Message" OWNER TO nhendric;


--
-- Name: profile_seq; Type: SEQUENCE; Schema: public; Owner: nhendric
--
...
ALTER TABLE public.profile_seq OWNER TO nhendric;

--
-- Name: Profile; Type: TABLE; Schema: public; Owner: nhendric
--
...
ALTER TABLE public."Profile" OWNER TO nhendric;


-- Name: visit_seq; Type: SEQUENCE; Schema: public; Owner: nhendric
--
...
ALTER TABLE public.visit_seq OWNER TO nhendric;

--
-- Name: Visit; Type: TABLE; Schema: public; Owner: nhendric
--
...
ALTER TABLE public."Visit" OWNER TO nhendric;
...
--
-- Name: Like pk_Like; Type: CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Match pk_Match; Type: CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Message pk_Message; Type: CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Profile pk_Profile; Type: CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Report fk_Report_reported_user; Type: FK CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Report fk_Report_reporting_user; Type: FK CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Like fk_Like_liked_user; Type: FK CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Like fk_Like_liking_user; Type: FK CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Match fk_Match_user1; Type: FK CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Match fk_Match_user2; Type: FK CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Message fk_Message_author; Type: FK CONSTRAINT; Schema: public; Owner: nhendric
--
...
--
-- Name: Message fk_Message_match; Type: FK CONSTRAINT; Schema: public; Owner: nhendric
--
